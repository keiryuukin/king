<footer class="footer-2 bg-dark pt96 pt-xs-40"  style="background-image: url(img/back4.jpg); background-size: cover; background-position: 100% 100%; background-repeat: no-repeat;">
	<div class="container">
		<div class="row">
			<div class="col-sm-10 col-sm-offset-1">
				...
				<div class="col-sm-6">
					...
					<div class="col-sm-12">
						<p>
							本公司提供的服務並非在任何司法管轄區都可承做任何期貨產品之招攬或操作。
							請貴賓自行查詢當地的司法管轄區是否可以合規使用我們提供的服務再進行投資。
						</p>
					</div>
						<div class="col-sm-12 mt16">
						<p style="font-size: 12px;color: #ff5d5d;line-height: 16px;" class="mb8">
