    ...
    <div class="container">
        <div class="row mb40 mb-xs-0">
            <div class="col-sm-10 col-sm-offset-1 text-center">
                <h3 class="uppercase deepblue mb16">金融監管授權<br>全球領先的期貨交易服務平台</h3>
            </div>
        </div>
        <div class="row">
        	<div class="col-sm-10 col-sm-offset-1 text-center mb40">
        		<div class="col-sm-6">
        		    <div class="feature feature-2 filled text-center">
        		        ...
        		        <div class="section1block">
        		            ...
        		            <h5 class="uppercase mb0">香港特別行政區政府公司註冊處
        		...
        		<div class="col-sm-6">
        		    <div class="feature feature-2 filled text-center">
        		        ...
        		        <div class="section1block">
        		            ...
        		            <h5 class="uppercase mb0">澳大利亞證券與投資委員會
                ...
                <div class="col-sm-4">
                    <div class="feature feature-2 filled text-center">
                        ...
                        <div class="section1block">
                            ...
                            <h5 class="uppercase">澳大利亞最佳交易商</h5>
                        </div>
                    </div>
